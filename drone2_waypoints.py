...
class DroneController:
    def __init__(self):
        rospy.init_node('drone2_control_script')
        
        # Create publisher and service clients
        self.local_position_publisher = rospy.Publisher('/drone2/mavros/setpoint_raw/local', PositionTarget, queue_size=10)
        ...
        self.takeoff_client = rospy.ServiceProxy('/drone2/mavros/cmd/takeoff', CommandTOL)
        
        # Drone 2 waypoints from waypoints.txt
        self.drone_waypoints = [
            (11.0, 13.0, 10), (12.0, 13.0, 10), (13.0, 13.0, 10), (14.0, 13.0, 10), (15.0, 13.0, 10),
            (16.0, 13.0, 10), (17.0, 12.0, 10), (18.0, 11.0, 10), (19.0, 11.0, 10), (20.0, 11.0, 10),
            (21.0, 11.0, 10), (22.0, 11.0, 10), (23.0, 11.0, 10), (24.0, 11.0, 10), (25.0, 11.0, 10),
            (26.0, 10.0, 10), (27.0, 10.0, 10), (28.0, 10.0, 10), (29.0, 10.0, 10), (30.0, 10.0, 10),
            (31.0, 10.0, 10), (32.0, 10.0, 10), (33.0, 10.0, 10), (34.0, 10.0, 10), (35.0, 10.0, 10),
            (36.0, 10.0, 10), (34.6, 5.5, 10), (35.6, 5.5, 10), (36.6, 5.5, 10), (37.6, 6.0, 10),
            (38.6, 5.0, 10), (39.6, 4.0, 10), (40.6, 4.0, 10), (41.6, 4.0, 10), (42.6, 3.0, 10),
            (43.6, 3.0, 10), (44.6, 3.0, 10), (45.6, 3.0, 10), (46.6, 3.0, 10), (47.6, 3.0, 10),
            (51.0, 7.0, 10), (52.0, 8.0, 10), (53.0, 9.0, 10), (54.0, 10.0, 10), (54.0, 11.0, 10),
            (54.0, 12.0, 10), (55.0, 13.0, 10), (55.0, 14.0, 10), (55.0, 15.0, 10), (56.0, 16.0, 10),
            (57.0, 17.0, 10), (58.0, 18.0, 10), (59.0, 19.0, 10), (60.0, 20.0, 10), (61.0, 21.0, 10),
            (62.0, 22.0, 10), (63.0, 23.0, 10), (64.0, 24.0, 10), (65.0, 25.0, 10), (66.0, 26.0, 10),
            (67.0, 27.0, 10), (68.0, 28.0, 10), (69.0, 29.0, 10), (70.0, 30.0, 10), (70.0, 31.0, 10),
            ...
            (91.0, 52.0, 10), (92.0, 53.0, 10), (93.0, 54.0, 10), (94.0, 55.0, 10), (95.0, 56.0, 10),
            (95.6, 54.5, 10), (95.6, 55.5, 10), (96.6, 56.5, 10), (96.6, 57.5, 10), (96.6, 58.5, 10),
            (96.6, 59.5, 10), (96.6, 60.5, 10), (96.6, 61.5, 10), (95.6, 62.5, 10), (97.0, 68.0, 10),
            (97.0, 69.0, 10), (96.0, 70.0, 10), (96.0, 71.0, 10), (96.0, 72.0, 10), (96.0, 73.0, 10),
            (96.0, 74.0, 10), (96.0, 75.0, 10), (96.0, 76.0, 10), (96.0, 77.0, 10), (96.0, 78.0, 10),
            (95.0, 81.0, 10), (95.0, 82.0, 10), (95.0, 83.0, 10), (94.0, 84.0, 10), (94.0, 85.0, 10),
            (93.0, 86.0, 10), (93.0, 87.0, 10), (92.0, 88.0, 10), (92.0, 89.0, 10), (91.0, 90.0, 10)
        ]
